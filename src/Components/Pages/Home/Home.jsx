  ...
  return (
    <div>
      ...
      <div className='mt-28 flex flex-col items-center space-y-10'>
        <h1 className='text-2xl lg:text-3xl'>Join Us as a Volunteer Making a Difference Together</h1>
        <p className='text-left lg:text-center w-full lg:w-[70%] text-lg leading-8'>Looking for a way to give back to your community? Join us as a volunteer! Whether you have a little or a lot of time to spare, your contribution can make a real difference in the lives of others. Get involved today!</p>
      </div>
