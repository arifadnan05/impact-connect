            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-12 mx-auto">
                    <div className="flex flex-col items-center">
                        <h1 className="text-4xl font-semibold text-[#134D22] lg:text-4xl dark:text-white">Our Programs</h1>
                        <p className="mt-2 text-2xl text-gray-500 dark:text-gray-300">We offer a range of programs focused on education, healthcare, environment, and more.</p>
